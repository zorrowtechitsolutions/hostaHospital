// src/components/super-admin/hospitals/Ambulance/AddAmbulance.jsx
...
import { useCreateAmbulanceMutation } from '../../../../../app/service/ambulance';
...
const AddAmbulance = () => {
  ...
  const [createAmbulance, { isLoading: isSubmitting }] = useCreateAmbulanceMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (hospitalId) {
        navigate(`/super-admin/hospitals/${hospitalId}/ambulances`);
      } else {
        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Add a new ambulance service to the system</p>
            </div>
          </div>
        </div>
